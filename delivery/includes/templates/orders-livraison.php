     ...
     if($stmt->execute())
     {
        ...
        "<script>
            swal({
                ...
                window.open('?page=orders-livraison','_self');
            });
        </script>";
     }
     else
...
<div class="container-fluid dashboard">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tous Les Commandes en livraison</h1>
    </div>
                ...
                <div class="col-12">
                    <div class="card card-last-orders shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Tous Les Commandes en livraison</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                            <table class="table text-center ">
                                <thead>
                                 ...
                                 <tbody>
                                     ...
                                     $orders = getFrom("commande","*","WHERE CINLivreure = '$cin' AND status = 'en livraison' ORDER BY Numero DESC");
